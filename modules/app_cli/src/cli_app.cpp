...
void install_default_logging(const std::string& log_level) {
    ...
    if      (log_level == "trace")    lvl = Level::trace;
    else if (log_level == "debug")    lvl = Level::debug;
    else if (log_level == "info")     lvl = Level::info;
    else if (log_level == "warn")     lvl = Level::warn;
    else if (log_level == "error")    lvl = Level::err;
    else if (log_level == "critical") lvl = Level::critical;
    else if (log_level == "off")      lvl = Level::off;
